...
export const CATALOG_SEED_QCMS: SeedCatalogQcm[] = [
  ...
  // ——— Suites (Quiz 4 · 6 questions chacun) ———
  {
    id: "seed-qcm-fr-4",
    ...
    questions: [
      {
        id: "fr4-q1",
        prompt: "« Ce film, je ___ ai vu trois fois » (COD masculin singulier).",
        options: ["le", "l’", "en"],
        correct: 1,
      },
      {
        id: "fr4-q2",
        prompt: "« Elle ___ écrit à ses parents » (COI pluriel).",
        options: ["leur", "les", "lui"],
        correct: 0,
      },
      {
        id: "fr4-q3",
        prompt: "« La ville ___ je suis né » : pronom relatif adapté.",
        options: ["où", "que", "dont"],
        correct: 0,
      },
      {
        id: "fr4-q4",
        prompt: "« C’est le garçon ___ parle le plus fort » (sujet).",
        options: ["que", "qui", "dont"],
        correct: 1,
      },
      {
        id: "fr4-q5",
        prompt: "« J’ai besoin ___ temps » (relatif de cause / complément).",
        options: ["que", "où", "dont"],
        correct: 2,
      },
      {
        id: "fr4-q6",
        prompt: "« Tu ___ connais, cette chanson ? » (COD féminin singulier).",
        options: ["la", "lui", "en"],
        correct: 0,
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "es4-q1",
        prompt: "« Mañana ___ a las ocho » (levantarse, futur de « yo »).",
        options: ["me levanto", "me levantaré", "me levantaba"],
        correct: 1,
      },
      {
        id: "es4-q2",
        prompt: "« Si tuviera tiempo, ___ más idiomas » (condicional / hipótesis).",
        options: ["estudio", "estudiaré", "estudiaría"],
        correct: 2,
      },
      {
        id: "es4-q3",
        prompt: "3e pers. sing. futur de « hablar » :",
        options: ["hablará", "hablaría", "habla"],
        correct: 0,
      },
      {
        id: "es4-q4",
        prompt: "« Dentro de un año ya ___ graduado » (ser, 1re pers. sing., futur).",
        options: ["seré", "sería", "soy"],
        correct: 0,
      },
      {
        id: "es4-q5",
        prompt: "« ___ llover, no saldremos » (si + présent indicatif, protasis réelle).",
        options: ["Si", "Cuando", "Aunque"],
        correct: 0,
      },
      {
        id: "es4-q6",
        prompt: "« Te ___ el libro mañana » (devolver, futur, « yo »).",
        options: ["devuelvo", "devolveré", "devolvía"],
        correct: 1,
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        id: "en4-q2",
        prompt: "« The letter ___ yesterday » (écrire, passif).",
        options: ["was written", "wrote", "has written"],
        correct: 0,
      },
      {
        id: "en4-q3",
        prompt: "« He ___ be the manager; I’m not sure. » (déduction incertaine).",
        options: ["must", "might", "can’t"],
        correct: 1,
      },
      {
        id: "en4-q4",
        prompt: "« You ___ to wear a uniform at that school » (obligation externe).",
        options: ["have", "must", "might"],
        correct: 0,
      },
      {
        id: "en4-q5",
        prompt: "« The test ___ at 9 a.m. tomorrow » (passif futur / plan).",
        options: ["will be given", "give", "is giving"],
        correct: 0,
      },
      {
        id: "en4-q6",
        prompt: "« I’d rather you ___ so loud » (prétérit modifié après would rather).",
        options: ["don’t speak", "didn’t speak", "not speak"],
        correct: 1,
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "enus4-q1",
        prompt: "« I ___ dinner when you called » (cooking was in progress).",
        options: ["cooked", "was cooking", "have cooked"],
        correct: 1,
      },
      {
        id: "enus4-q2",
        prompt: "« She’s from Texas, ___? » (question tag, US standard).",
        options: ["isn’t she", "is she", "doesn’t she"],
        correct: 0,
      },
      {
        id: "enus4-q3",
        prompt: "« I’ll catch ___ with you later » (être à jour).",
        options: ["up", "on", "out"],
        correct: 0,
      },
      {
        id: "enus4-q4",
        prompt: "« Different ___ » (US préposition courante).",
        options: ["than", "to", "from"],
        correct: 0,
      },
      {
        id: "enus4-q5",
        prompt: "« Could you ___ me the salt? » (passer / tendre).",
        options: ["pass", "past", "passing"],
        correct: 0,
      },
      {
        id: "enus4-q6",
        prompt: "« Ten after six » en notation numérique US ≈",
        options: ["6:50", "6:10", "5:50"],
        correct: 1,
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "de4-q1",
        prompt: "« Ich helfe ___ Kind » (neutre, datif).",
        options: ["dem", "den", "das"],
        correct: 0,
      },
      {
        id: "de4-q2",
        prompt: "« Das Buch liegt ___ dem Tisch » (position fixe, Dativ).",
        options: ["auf", "an", "über"],
        correct: 0,
      },
      {
        id: "de4-q3",
        prompt: "« Ich gehe ___ Park » (mouvement vers l’intérieur, acc. avec « in » + A.).",
        options: ["in den", "im", "in dem"],
        correct: 0,
      },
      {
        id: "de4-q4",
        prompt: "« Er gibt ___ Frau einen Kaffee » (datif de la personne).",
        options: ["der", "die", "den"],
        correct: 0,
      },
      {
        id: "de4-q5",
        prompt: "« Mit ___ Freunden » (pluriel, préposition « mit » + Dativ).",
        options: ["meinen", "meine", "meinem"],
        correct: 0,
      },
      {
        id: "de4-q6",
        prompt: "« Trotz ___ Regens » (génitif vieilli ou datif moderne — ici forme répandue avec article défini au génitif « des Regens » ou préposition « trotz » + Gen.: mot attendu).",
        options: ["des", "dem", "den"],
        correct: 0,
      },
    ],
    ...
    questions: [
      {
        id: "zh4-q1",
        prompt: "« 我在家 » signifie :",
        options: ["Je suis à la maison", "Je vais à la maison", "Je quitte la maison"],
        correct: 0,
      },
      {
        id: "zh4-q2",
        prompt: "« 去学校 » signifie environ :",
        options: ["aller à l’école", "être à l’école", "rentrer de l’école"],
        correct: 0,
      },
      {
        id: "zh4-q3",
        prompt: "« 来 » opposé fréquent de « 去 » — « venir » vs :",
        options: ["reste", "aller", "manger"],
        correct: 1,
      },
      {
        id: "zh4-q4",
        prompt: "« 桌子上 » évoque en général :",
        options: ["sous la table", "sur la table", "derrière la table"],
        correct: 1,
      },
      {
        id: "zh4-q5",
        prompt: "« 里边 » (lǐbian) suggère souvent :",
        options: ["à l’intérieur / dedans", "dehors", "au-dessus"],
        correct: 0,
      },
      {
        id: "zh4-q6",
        prompt: "« 他从中国来 » signifie :",
        options: [
          "Il va en Chine",
          "Il vient de Chine",
          "Il habite en Chine sans mouvement",
        ],
        correct: 1,
      },
    ],
