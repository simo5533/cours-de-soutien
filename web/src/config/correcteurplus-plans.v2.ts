/**
 * CorrecteurPlus 2.0 — référentiel des packs et micro-services (paiement cible : CMI).
...
export const CorrecteurPlus_PLANS_VERSION = "2.0.0";
...
export const IMPORTANT_CMI_NOTE = {
  ...
  webhook_endpoint: "https://CorrecteurPlus.ma/api/webhooks/cmi",
  success_url: "https://CorrecteurPlus.ma/dashboard?payment=success",
  cancel_url: "https://CorrecteurPlus.ma/abonnement?payment=cancelled",
} as const;
...
export const PLAN_SUMMARIES: Record<CorrecteurPlusPlanId, PlanSummary> = {
  starter: {
    id: "starter",
    name: "Gratuit",
    priceMad: 0,
...
export function getCorrectionsLimitForPlan(planId: CorrecteurPlusPlanId): number {
  if (planId === "starter") return 3;
  return -1;
}

export function isPaidPlan(planId: CorrecteurPlusPlanId): boolean {
