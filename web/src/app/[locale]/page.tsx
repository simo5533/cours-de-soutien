        ...
        <section className="mt-20" aria-labelledby="services-heading">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {seo.services.map((item, i) => {
              const accents = [
                "from-brandblue to-navy",
                "from-navy to-brandblue",
                "from-gold to-navy",
                "from-brandblue via-navy to-brandblue",
                "from-navy via-gold/70 to-navy",
              ];
              return (
              <div
                key={item.title}
              ...
              >
                <div
                  className={`inline-flex w-fit rounded-xl bg-gradient-to-br ${accents[i % accents.length]} px-3 py-1 text-xs font-bold tracking-wide text-white shadow-md`}
                >
                  {t("svcCardBadge")}
                </div>
